...
public class Driver {
    ...
    public static WebDriver getDriver() {
        ...
        if (driverPool.get() == null) {
            ...
            desiredCapabilities.setCapability("platformName", "mac");//İşletim sistemi belirtilir


            try {
                driver = new RemoteWebDriver(new URL("http://192.168.1.8:4444"), desiredCapabilities);
